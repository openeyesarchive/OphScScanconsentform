...
class OphScScanconsentformModule extends BaseEventTypeModule
{
	...
	public function init() {
		...
		$this->setImport(array(
			'OphScScanconsentform.models.*',
			'OphScScanconsentform.components.*',
		));
		
		$this->moduleShortSuffix = "scanconsentform";
	}
