...
/**
 * This is the model class for table "et_ophscscanconsentform_document".
 *
...
class Element_OphScScanconsentform_Document extends ElementScannedDocument
{
	public $service;
	...
	{
		return 'et_ophscscanconsentform_document';
	}
